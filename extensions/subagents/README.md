...
const CUSTOM_TOOL_EXTENSIONS: Record<string, string> = {
  "web-access": path.join(PI_AGENT_DIR, "npm", "node_modules", "pi-web-access", "index.ts"),
  web_fetch: path.join(EXT_DIR, "../web-fetch/index.ts"),
  safe_bash: path.join(EXT_DIR, "tools/safe-bash.ts"),
};
```
